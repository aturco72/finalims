  ...
  <ion-page>
    <ion-header :translucent="true">
      <ion-toolbar color="primary">
        ...
        <ion-title>Fertirrigazioni</ion-title>
    ...
    <ion-content fullscreen>
          ...
          >
            ...
            <ion-item lines="none" v-if="cedo == cedolino" color="light">
              <ion-grid v-if="cedo == cedolino">
                ...
                <ion-row v-for="(s, cd_vasca) in cedo.Scar" :key="cd_vasca">
                  <ion-col size="5" style="text-align: left; font-size: 14px">
                    <b>{{ s.cd_vasca }}</b>
                  </ion-col>
                  <ion-col size="2" style="text-align: right; font-size: 14px">
                    {{ numToString(s.iniziale, 0, 0, "") }}
                  </ion-col>
                  <ion-col size="2" style="text-align: right; font-size: 14px">
                    {{ numToString(s.finale, 0, 0, "") }}
                  </ion-col>
                  <ion-col
                    size="3"
                    style="text-align: right; font-size: 14px; color: red"
                  >
                    {{ numToString(parseFloat(s.consumo), 1, 1, "lt.") }}
                  </ion-col>
                </ion-row>
              </ion-grid>
            </ion-item>
      ...
      <div v-else id="container">
        <h2>Nessuna Fertirrigazione inserita</h2>
...
export default defineComponent({
  ...
  computed: {},
  setup() {
    return { colorFill, addCircleSharp, arrowForwardCircle, checkmark, trash };
  },
});
</script>
